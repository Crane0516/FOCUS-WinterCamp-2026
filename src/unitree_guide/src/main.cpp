...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh; // 新增：节点句柄
    // 新增：订阅/cmd_vel话题
    ros::Subscriber cmd_vel_sub = nh.subscribe(
        "/cmd_vel", 10, KeyBoard::cmdVelCallback
    );
    ros::Rate loop_rate(500); // 新增：500Hz循环
    ...
    while (running)
    {
        ...
        #ifdef RUN_ROS
        ros::spinOnce(); // 新增：处理ROS回调
        loop_rate.sleep(); // 新增：按频率休眠
#endif // RUN_ROS
    }
